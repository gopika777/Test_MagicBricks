...
public class ShortlistProperty_Page {
	...
	public static By lowhigh = By.xpath("//*[@id=\"body\"]/div[5]/div/div/div[1]/div[1]/div/div[2]/ul/li[2]");
	...
	public boolean sortByFilter() {
		...
		try {
			...
			shortlistBtn1.click();
			WebElement shortlistBtn2 = wait.until(ExpectedConditions.elementToBeClickable(lowhigh));
			shortlistBtn2.click();
