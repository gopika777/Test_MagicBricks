...
public class searchHome extends BaseSteps {
	...
	public void the_user_is_on_the_magicbricks_home_page() {
		...
		Assert.assertTrue(actUrl.contains("magicbricks.com"),"User is not on the Magicbricks home page. Current URL: " + actUrl);
		if (excelData == null) {
	...
	@When("the user selects Property Type from dropdown")
	public void the_user_selects_property_type_from_dropdown() {
