...
import com.Pages.PropertyPhotosPage;
...
public class PropertyPhoto extends BaseSteps {
	
    ExtentTest extTest = Hooks.extTest;
    PropertyPhotosPage propertyPhotos;
    ...
    public void i_click_the_photo_gallery() {
        propertyPhotos = new PropertyPhotosPage(driver, Hooks.extTest);
