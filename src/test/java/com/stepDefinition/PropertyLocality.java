...
import com.Pages.PropertyLocalityPage;
...
public class PropertyLocality extends BaseSteps {
	PropertyLocalityPage propertyLocalityPage;
	...
	public void I_click_on_the_section(String string) {
		propertyLocalityPage = new PropertyLocalityPage(driver, Hooks.extTest);
		boolean actResult = propertyLocalityPage.clickAboutLocality();
	...
	public void I_click_the_right_arrow_to_view_more_locality_details() {
		boolean actResult = propertyLocalityPage.clickRightArrow();
	...
	public void I_click_on_the_dropdown_to_view_the_ratings() {
		boolean actResult = propertyLocalityPage.clickRatingDropdown();
	...
	public void I_scroll_up_to_the_top_of_the_page() {
		boolean actResult = propertyLocalityPage.scrollToTop();
